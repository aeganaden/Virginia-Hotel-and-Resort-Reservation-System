...
CREATE TABLE IF NOT EXISTS `virginia`.`reservation` (
  ...
  INDEX `fk_reservation_guest1_idx` (`guest_id` ASC),
...
CREATE TABLE IF NOT EXISTS `virginia`.`billing` (
  ...
  INDEX `fk_billing_reservation_idx` (`reservation_id` ASC),
  CONSTRAINT `fk_billing_reservation`
    FOREIGN KEY (`reservation_id`)
    REFERENCES `virginia`.`reservation` (`reservation_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
